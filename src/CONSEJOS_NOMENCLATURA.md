...
- ❌ No aprovechar el renombrado para «colar» arreglos de bugs. Esos van en
  [`MEJORAS_PENDIENTES.md`](MEJORAS_PENDIENTES.md) y tienen su propia prioridad.
...
- [`MEJORAS_PENDIENTES.md`](MEJORAS_PENDIENTES.md) — bugs y mejoras funcionales ordenados por prioridad.
- [`README.md`](README.md) — visión general de la solución.
- [`MoralesLarios.FOOP/__Doc/1_Intro.md`](MoralesLarios.FOOP/__Doc/1_Intro.md) — convenciones de
  nomenclatura **actuales** del núcleo (`[Try][Operación][Contexto][Async]`).
