# Mejoras pendientes en MoralesLarios.OOFP

> 📌 **Qué es este documento.** Un inventario de todo lo que conviene arreglar en la solución,
> **ordenado de más a menos prioritario**. Cada entrada indica el **proyecto**, el **archivo o
