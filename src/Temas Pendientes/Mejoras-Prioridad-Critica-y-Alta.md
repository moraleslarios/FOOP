# Mejoras pendientes · 🔴 Prioridad crítica y 🟠 alta

> 📌 **Qué es este documento.** El primer tramo del inventario de mejoras de la solución: **lo que hay
> que arreglar antes que nada**. Cada entrada indica el **proyecto**, el **archivo o clase** y el
> **método** donde está el problema, qué consecuencia tiene y una propuesta concreta de arreglo. La
> idea es que puedas ir marcando casillas poco a poco sin tener que volver a investigar el código.

> ℹ️ Los renombrados de clases, métodos y propiedades **no** están aquí: viven en
> [`Consejos-Nomenclatura.md`](Consejos-Nomenclatura.md). Este documento trata de **comportamiento**
> (bugs, seguridad, fiabilidad y contratos rotos).
...
**Continúa en otros documentos:**

- 🟡 Prioridad media (puntos 38-63) → [`Mejoras-Prioridad-Media.md`](Mejoras-Prioridad-Media.md)
- 🟢 Prioridad baja (puntos 64-89) → [`Mejoras-Prioridad-Baja.md`](Mejoras-Prioridad-Baja.md)
- Plan de trabajo sugerido → [`README.md`](README.md)
...
| Prioridad | Nº de puntos | Naturaleza dominante | Documento |
|---|---|---|---|
| 🔴 Crítico | 16 | Bugs de lógica y tipos inconstruibles | **este** |
| 🟠 Alto | 21 | Seguridad, DI, códigos HTTP, culturas | **este** |
| 🟡 Medio | 26 | Rendimiento en EF Core, diseño de API | [`Mejoras-Prioridad-Media.md`](Mejoras-Prioridad-Media.md) |
| 🟢 Bajo | 26 | Ficheros muertos, mensajes, coherencia | [`Mejoras-Prioridad-Baja.md`](Mejoras-Prioridad-Baja.md) |
| **Total** | **89** | | |
...
| `MoralesLarios.OOFP.ValueObjects` | 4 | 1 | 2 | 3 | `DecimalNotNegative` inconstruible |
| `MoralesLarios.OOFP.ValueObjects.IO` | 2 | 1 | 0 | 1 | Paréntesis mal anidados en `ExistsFile` |
| `…Validation(.Dataannotations/.FluentValidations)` | 2 | 1 | 4 | 2 | Colisión de `ValidateObject` (CS0121) |
| `MoralesLarios.OOFP.EFCore` | 1 | 4 | 3 | 2 | `DbContext` liberado por el repositorio |
| `MoralesLarios.OOFP.WebServices` | 1 | 3 | 2 | 2 | 500 en lugar de 404 |
| `MoralesLarios.OOFP.WebApi` | 1 | 3 | 0 | 2 | `Created` incluso al fallar |
| `MoralesLarios.OOFP.WebControllers` | 1 | 5 | 6 | 4 | Culturas en el parseo de fechas |
| `MoralesLarios.OOFP.HttpClients` | 2 | 3 | 8 | 6 | Volcado del cuerpo de respuesta en el error |
...
- [`Profesionalizacion-Ingenieria-y-Calidad.md`](Profesionalizacion-Ingenieria-y-Calidad.md) — pruebas, analizadores y CI que evitan que estos fallos vuelvan.
- [`README.md`](README.md) — plan de trabajo por bloques.
